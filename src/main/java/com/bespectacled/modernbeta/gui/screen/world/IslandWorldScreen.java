...
public class IslandWorldScreen extends InfWorldScreen {
    ...
    protected void init() {
        ...
        BooleanOption generateOuterIslands =
            new BooleanOption(
                ...
                (gameOptions, value) -> this.worldSettings.putSetting(WorldSetting.CHUNK, "generateOuterIslands", ByteTag.of(value))
            );
        ...
        DoubleOption centerIslandRadius =
            new DoubleOption(
                ...
                (gameOptions, value) -> this.worldSettings.putSetting(WorldSetting.CHUNK, "centerIslandRadius", IntTag.of(value.intValue())),
        ...
        DoubleOption centerIslandFalloff =
                ...
                (gameOptions, value) -> this.worldSettings.putSetting(WorldSetting.CHUNK, "centerIslandFalloff", FloatTag.of(value.floatValue())),
                (gameOptions, doubleOptions) -> {
                    return new TranslatableText(
                        "options.generic_value", 
                        new Object[] { 
        ...
        DoubleOption centerOceanLerpDistance =
            new DoubleOption(
                ...
                (gameOptions, value) -> this.worldSettings.putSetting(WorldSetting.CHUNK, "centerOceanLerpDistance", IntTag.of(value.intValue())),
                (gameOptions, doubleOptions) -> {
                    return new TranslatableText(
                        "options.generic_value", 
                        new Object[] { 
        ...
        DoubleOption centerOceanRadius =
            new DoubleOption(
                ...
                (gameOptions, value) -> this.worldSettings.putSetting(WorldSetting.CHUNK, "centerOceanRadius", IntTag.of(value.intValue())),
                (gameOptions, doubleOptions) -> {
                    return new TranslatableText(
                        "options.generic_value", 
                        new Object[] { 
        ...
        DoubleOption outerIslandNoiseScale = 
            new DoubleOption(
                ...
                (gameOptions, value) -> this.worldSettings.putSetting(WorldSetting.CHUNK, "outerIslandNoiseScale", FloatTag.of(value.floatValue())),
                (gameOptions, doubleOptions) -> {
                    return new TranslatableText(
                        "options.generic_value", 
                        new Object[] { 
        ...
        DoubleOption outerIslandNoiseOffset = 
            new DoubleOption(
                ...
                (gameOptions, value) -> this.worldSettings.putSetting(WorldSetting.CHUNK, "outerIslandNoiseOffset", FloatTag.of(value.floatValue())),
                (gameOptions, doubleOptions) -> {
                    return new TranslatableText(
                        "options.generic_value", 
                        new Object[] { 
