    ...
    protected void init() {
        ...
        CyclingOption<IndevTheme> levelTheme = 
            CyclingOption.create(
                ...
                (gameOptions) -> IndevTheme.fromName(NBTUtil.readString("levelTheme", this.worldSettings.getChunkSettings(), ModernBeta.GEN_CONFIG.indevLevelTheme)), 
                (gameOptions, option, value) -> {
                    this.worldSettings.putChunkSetting("levelTheme", NbtString.of(value.getName()));
        ...
        CyclingOption<IndevType> levelType = 
            CyclingOption.create(
                ...
                (gameOptions) -> IndevType.fromName(NBTUtil.readString("levelType", this.worldSettings.getChunkSettings(), ModernBeta.GEN_CONFIG.indevLevelType)), 
                (gameOptions, option, value) -> this.worldSettings.putChunkSetting("levelType", NbtString.of(value.getName()))
            );
        ...
        DoubleOption levelWidth = 
            new DoubleOption(
                ...
                128D, 1024D, 128f,
                (gameOptions) -> (double)NBTUtil.readInt("levelWidth", this.worldSettings.getChunkSettings(), ModernBeta.GEN_CONFIG.indevLevelWidth), // Getter
                (gameOptions, value) -> this.worldSettings.putChunkSetting("levelWidth", NbtInt.of(value.intValue())),
                (gameOptions, doubleOptions) -> {
                    return new TranslatableText(
                        "options.generic_value", 
                        new Object[] { 
                            new TranslatableText("createWorld.customize.indev.levelWidth"), 
                            Text.of(String.valueOf(NBTUtil.readInt("levelWidth", this.worldSettings.getChunkSettings(), ModernBeta.GEN_CONFIG.indevLevelWidth))) 
                    });
                }
            );
        ...
        DoubleOption levelLength =
            new DoubleOption(
                ...
                128D, 1024D, 128f,
                (gameOptions) -> (double)NBTUtil.readInt("levelLength", this.worldSettings.getChunkSettings(), ModernBeta.GEN_CONFIG.indevLevelLength), // Getter
                (gameOptions, value) -> this.worldSettings.putChunkSetting("levelLength", NbtInt.of(value.intValue())),
                (gameOptions, doubleOptions) -> {
                    return new TranslatableText(
                        "options.generic_value", 
                        new Object[] { 
                            new TranslatableText("createWorld.customize.indev.levelLength"), 
                            Text.of(String.valueOf(NBTUtil.readInt("levelLength", this.worldSettings.getChunkSettings(), ModernBeta.GEN_CONFIG.indevLevelLength))) 
                    });
                }
            );
        ...
        DoubleOption levelHeight =
            new DoubleOption(
                ...
                64D, (double)topY, 64F,
                (gameOptions) -> (double)NBTUtil.readInt("levelHeight", this.worldSettings.getChunkSettings(), ModernBeta.GEN_CONFIG.indevLevelHeight), // Getter
                (gameOptions, value) -> this.worldSettings.putChunkSetting("levelHeight", NbtInt.of(value.intValue())),
                (gameOptions, doubleOptions) -> {
                    return new TranslatableText(
                        "options.generic_value", 
                        new Object[] { 
                            new TranslatableText("createWorld.customize.indev.levelHeight"), 
                            Text.of(String.valueOf(NBTUtil.readInt("levelHeight", this.worldSettings.getChunkSettings(), ModernBeta.GEN_CONFIG.indevLevelHeight))) 
                    });
                }
            );
        ...
        DoubleOption caveRadius =
            new DoubleOption(
                ...
                1D, 3D, 0.1f,
                (gameOptions) -> (double)NBTUtil.readFloat("caveRadius", this.worldSettings.getChunkSettings(), ModernBeta.GEN_CONFIG.indevCaveRadius), // Getter
                (gameOptions, value) -> this.worldSettings.putChunkSetting("caveRadius", NbtFloat.of(value.floatValue())),
                (gameOptions, doubleOptions) -> {
                    return new TranslatableText(
                        "options.generic_value", 
                        new Object[] { 
                            new TranslatableText("createWorld.customize.indev.caveRadius"), 
                            Text.of(String.format("%.01f", NBTUtil.readFloat("caveRadius", this.worldSettings.getChunkSettings(), ModernBeta.GEN_CONFIG.indevCaveRadius)))  
                    });
                }
            );
