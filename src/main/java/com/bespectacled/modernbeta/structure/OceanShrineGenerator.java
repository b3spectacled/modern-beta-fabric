    ...
    public static class Piece extends SimpleStructurePiece {
        ...
        private int method_14829(BlockPos blockPos2, BlockView blockView, BlockPos blockPos4) {
            ...
            for (final BlockPos lv : BlockPos.iterate(blockPos2, blockPos4)) {
                ...
                for (FluidState lv4 = blockView.getFluidState(mutable14); (blockState15.isAir() || lv4.isIn(FluidTags.WATER) || blockState15.getBlock().isIn(BlockTags.ICE)) && integer13 > 1; blockState15 = blockView.getBlockState(mutable14), lv4 = blockView.getFluidState(mutable14)) {
                    --integer13;
