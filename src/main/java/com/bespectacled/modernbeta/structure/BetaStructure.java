...
public class BetaStructure {
    ...
    public static final RegistryKey<ConfiguredStructureFeature<?, ?>> OCEAN_SHRINE_KEY = 
        RegistryKey.of(Registry.CONFIGURED_STRUCTURE_FEATURE_WORLDGEN, OCEAN_SHRINE_ID);
