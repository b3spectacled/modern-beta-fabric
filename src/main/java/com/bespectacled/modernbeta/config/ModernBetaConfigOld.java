...
public final class ModernBetaConfigOld {
    ...
    public static ModernBetaConfigOld loadConfig() {
        return readConfig();
    }

    private static ModernBetaConfigOld createConfig() {
        ModernBetaConfigOld config = new ModernBetaConfigOld();
    ...
    private static ModernBetaConfigOld readConfig() {
        ModernBetaConfigOld config = null;

        try {
            BufferedReader bufferedReader = new BufferedReader(new FileReader(PATH.toFile()));

            config = GSON.fromJson(bufferedReader, ModernBetaConfigOld.class);
        } catch (IOException e) {
