...
public class Plains {
    ...
    private static Biome create() {
        ...
        genSettings.feature(Feature.VEGETAL_DECORATION, BetaConfiguredFeature.PATCH_DANDELION_3);
        genSettings.feature(Feature.VEGETAL_DECORATION, BetaConfiguredFeature.PATCH_GRASS_PLAINS_10);
