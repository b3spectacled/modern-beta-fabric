...
public class IndevWorldScreen extends InfWorldScreen {
    ...
    protected void init() {
        ...
        String levelThemeStr = NBTUtil.toString(this.worldSettings.getSetting(WorldSetting.CHUNK, "levelTheme"), ModernBeta.GEN_CONFIG.indevLevelTheme);
        String levelTypeStr = NBTUtil.toString(this.worldSettings.getSetting(WorldSetting.CHUNK, "levelType"), ModernBeta.GEN_CONFIG.indevLevelType);
