...
public class BetaSurfaceBuilder {
    ...
    public static final SurfaceBuilder BEACH_SURFACE_BUILDER = add("beach_surface_builder",
            new BeachSurfaceBuilder(TernarySurfaceConfig.CODEC));
    public static final ConfiguredSurfaceBuilder BEACH = add("beach",
            new ConfiguredSurfaceBuilder<TernarySurfaceConfig>(BetaSurfaceBuilder.BEACH_SURFACE_BUILDER,
