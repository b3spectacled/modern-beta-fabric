...
public class CountNoiseDecoratorConfig implements DecoratorConfig {
	...
	static {
        CODEC = RecordCodecBuilder.create(instance -> instance.group(
    		Codec.INT.fieldOf("density").forGetter(countBetaNoiseDecoratorConfig -> countBetaNoiseDecoratorConfig.density), 
    		Codec.LONG.fieldOf("seed").forGetter(countBetaNoiseDecoratorConfig -> countBetaNoiseDecoratorConfig.seed), 
