...
public class SkylandsChunkProvider extends AbstractChunkProvider {
    ...
    public SkylandsChunkProvider(long seed, AbstractBiomeProvider biomeProvider, Supplier<ChunkGeneratorSettings> generatorSettings, CompoundTag providerSettings) {
        //super(seed, settings);
        super(seed, 128, 0, 0, -10, 1, 2, 2.0, 1.0, 80, 160, -30, 31, 0, -30, 7, 0,BlockStates.STONE, BlockStates.AIR, biomeProvider, generatorSettings, providerSettings);
