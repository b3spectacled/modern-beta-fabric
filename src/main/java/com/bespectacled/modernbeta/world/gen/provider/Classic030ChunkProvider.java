...
import com.bespectacled.modernbeta.api.world.gen.StructureWeightSampler;
...
public class Classic030ChunkProvider extends FiniteChunkProvider {
    ...
    @Override
    protected BlockState postProcessTerrainState(Block block, StructureWeightSampler weightSampler, TerrainState terrainState, BlockPos pos) {
        int x = pos.getX();
        int y = pos.getY();
        int z = pos.getZ();
        
        BlockState blockState = block.getDefaultState();
        BlockState modifiedBlockState = this.getBlockState(weightSampler, x, y, z, block, this.defaultFluid.getBlock(), this.defaultBlock.getBlock());
