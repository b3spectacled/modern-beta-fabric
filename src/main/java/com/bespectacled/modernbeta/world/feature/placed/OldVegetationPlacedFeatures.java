...
import com.bespectacled.modernbeta.world.feature.placement.Spread32AbovePlacementModifier;
...
public class OldVegetationPlacedFeatures {
    public static final Map<String, OldNoiseBasedCountPlacementModifier> NOISE_MODIFIERS = new HashMap<>();
    ...
    public static final PlacementModifier SPREAD_32_ABOVE_MODIFIER = Spread32AbovePlacementModifier.of();
    ...
    public static List<PlacementModifier> withNoiseBasedCountModifier(String id, OldNoiseBasedCountPlacementModifier modifier) {
        NOISE_MODIFIERS.put(id, modifier);
        
        return withBaseTreeModifiers(modifier).build();
    }
    
    public static void setNoiseOctaves(PerlinOctaveNoise octaves) {
        NOISE_MODIFIERS.entrySet().forEach(e -> e.getValue().setOctaves(octaves));
    }
    ...
    public static final PlacedFeature MUSHROOM_HELL = OldPlacedFeatures.register("mushroom_hell", OldVegetationConfiguredFeatures.MUSHROOM_HELL.withPlacement(CountPlacementModifier.of(2), SquarePlacementModifier.of(), SPREAD_32_ABOVE_MODIFIER, BiomePlacementModifier.of()));

    // Flowers
    public static final PlacedFeature PATCH_DANDELION_2 = OldPlacedFeatures.register("patch_dandelion_2", OldVegetationConfiguredFeatures.PATCH_DANDELION.withPlacement(CountPlacementModifier.of(2), SquarePlacementModifier.of(), SPREAD_32_ABOVE_MODIFIER, BiomePlacementModifier.of()));
    public static final PlacedFeature PATCH_DANDELION_3 = OldPlacedFeatures.register("patch_dandelion_3", OldVegetationConfiguredFeatures.PATCH_DANDELION.withPlacement(CountPlacementModifier.of(3), SquarePlacementModifier.of(), SPREAD_32_ABOVE_MODIFIER, BiomePlacementModifier.of()));
    public static final PlacedFeature PATCH_DANDELION_4 = OldPlacedFeatures.register("patch_dandelion_4", OldVegetationConfiguredFeatures.PATCH_DANDELION.withPlacement(CountPlacementModifier.of(4), SquarePlacementModifier.of(), SPREAD_32_ABOVE_MODIFIER, BiomePlacementModifier.of()));
    public static final PlacedFeature PATCH_DANDELION = OldPlacedFeatures.register("patch_dandelion", OldVegetationConfiguredFeatures.PATCH_DANDELION.withPlacement(withCountExtraModifier(0, 0.5f, 1), SquarePlacementModifier.of(), SPREAD_32_ABOVE_MODIFIER, BiomePlacementModifier.of()));
    public static final PlacedFeature PATCH_POPPY = OldPlacedFeatures.register("patch_poppy", OldVegetationConfiguredFeatures.PATCH_POPPY.withPlacement(withCountExtraModifier(0, 0.5f, 1), SquarePlacementModifier.of(), SPREAD_32_ABOVE_MODIFIER, BiomePlacementModifier.of()));
    public static final PlacedFeature PATCH_FLOWER_PARADISE = OldPlacedFeatures.register("patch_flower_paradise", VegetationConfiguredFeatures.FLOWER_DEFAULT.withPlacement(CountPlacementModifier.of(20), SquarePlacementModifier.of(), SPREAD_32_ABOVE_MODIFIER, BiomePlacementModifier.of()));
    ...
    // Grass
    public static final PlacedFeature PATCH_GRASS_PLAINS_10 = OldPlacedFeatures.register("patch_grass_plains_10",OldVegetationConfiguredFeatures.PATCH_GRASS.withPlacement(CountPlacementModifier.of(10), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of()));
    public static final PlacedFeature PATCH_GRASS_TAIGA_1 = OldPlacedFeatures.register("patch_grass_taiga_1", OldVegetationConfiguredFeatures.PATCH_GRASS.withPlacement(CountPlacementModifier.of(1), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of()));
    public static final PlacedFeature PATCH_GRASS_RAINFOREST_10 = OldPlacedFeatures.register("patch_grass_rainforest_10", OldVegetationConfiguredFeatures.PATCH_GRASS_LUSH.withPlacement(CountPlacementModifier.of(10), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of()));
    public static final PlacedFeature PATCH_GRASS_ALPHA_2 = OldPlacedFeatures.register("patch_grass_alpha_2", OldVegetationConfiguredFeatures.PATCH_GRASS.withPlacement(withCountExtraModifier(0, 0.1f, 1), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of()));
    ...
    // Indev Trees
    public static final PlacedFeature TREES_INDEV = OldPlacedFeatures.register("trees_indev", TreeConfiguredFeatures.OAK.withPlacement(CountPlacementModifier.of(UniformIntProvider.create(0, 1)), withCountExtraModifier(5, 0.1f, 1), SquarePlacementModifier.of(), SURFACE_WATER_DEPTH_MODIFIER, PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BiomePlacementModifier.of()));
    public static final PlacedFeature TREES_INDEV_WOODS = OldPlacedFeatures.register("trees_indev_woods", TreeConfiguredFeatures.OAK.withPlacement(withCountExtraModifier(30, 0.1f, 1), SquarePlacementModifier.of(), SURFACE_WATER_DEPTH_MODIFIER, PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BiomePlacementModifier.of()));
    
    // Indev Trees w/ bees
    public static final PlacedFeature TREES_INDEV_BEES = OldPlacedFeatures.register("trees_indev_bees", TreeConfiguredFeatures.OAK_BEES_0002.withPlacement(CountPlacementModifier.of(UniformIntProvider.create(0, 1)), withCountExtraModifier(5, 0.1f, 1), SquarePlacementModifier.of(), SURFACE_WATER_DEPTH_MODIFIER, PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BiomePlacementModifier.of()));
    public static final PlacedFeature TREES_INDEV_WOODS_BEES = OldPlacedFeatures.register("trees_indev_woods_bees", TreeConfiguredFeatures.OAK_BEES_0002.withPlacement(withCountExtraModifier(30, 0.1f, 1), SquarePlacementModifier.of(), SURFACE_WATER_DEPTH_MODIFIER, PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BiomePlacementModifier.of()));
