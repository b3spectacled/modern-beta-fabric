...
import com.bespectacled.modernbeta.world.feature.placement.noise.Infdev611NoisePlacer;
import com.mojang.serialization.Codec;
import com.mojang.serialization.codecs.RecordCodecBuilder;

import net.minecraft.world.gen.decorator.PlacementModifierType;

public class Infdev611NoiseBasedCountPlacementModifier extends OldNoiseBasedCountPlacementModifier {
    ...
    public void setOctaves(PerlinOctaveNoise octaves) {
        this.noiseDecorator = new Infdev611NoisePlacer(octaves);
    }
    
    @Override
    public PlacementModifierType<?> getType() {
        return OldPlacementTypes.INFDEV_611_NOISE_BASED_COUNT;
    }
