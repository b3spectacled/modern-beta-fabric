...
public class OldConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ORE_CLAY = register("ore_clay", ((OldFeatures.ORE_CLAY.configure(new OreFeatureConfig(new BlockMatchRuleTest(Blocks.SAND), Blocks.CLAY.getDefaultState(), 33)).method_36296(YOffset.fixed(0), YOffset.fixed(127))).spreadHorizontally().repeat(10)));
