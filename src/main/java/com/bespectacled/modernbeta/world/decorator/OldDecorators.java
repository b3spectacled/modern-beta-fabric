...
public class OldDecorators {
    ...
    public static final Spread32AboveDecorator SPREAD_32_ABOVE = (Spread32AboveDecorator) register("spread_32_above", new Spread32AboveDecorator(NopeDecoratorConfig.CODEC));
