            ...
            for(int k3 = 0; k3 < k; k3++)
            {
                ...
                for(int j4 = 0; j4 < j; j4++)
                {
                    ...
                    if(j4 == 0 || l4 != i1)
                    {
                        ...
                        d8 = lerp(d13, grad(permutations[k1], d12, d16, d14), grad(permutations[j2], d12 - 1.0D, d16, d14));
                        d9 = lerp(d13, grad(permutations[l1], d12, d16 - 1.0D, d14), grad(permutations[k2], d12 - 1.0D, d16 - 1.0D, d14));
                        d10 = lerp(d13, grad(permutations[k1 + 1], d12, d16, d14 - 1.0D), grad(permutations[j2 + 1], d12 - 1.0D, d16, d14 - 1.0D));
                        d11 = lerp(d13, grad(permutations[l1 + 1], d12, d16 - 1.0D, d14 - 1.0D), grad(permutations[k2 + 1], d12 - 1.0D, d16 - 1.0D, d14 - 1.0D));
                    }
