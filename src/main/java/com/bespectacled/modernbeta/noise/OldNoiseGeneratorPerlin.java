 ...
 */
public class OldNoiseGeneratorPerlin extends OldNoiseGenerator {
    ...
    public final double grad(int hash, double x, double y, double z) {
        /*
         * int h = hash & 0xf; double u = h >= 8 ? y : x; double v = h >= 4 ? h != 12 &&
         * h != 14 ? z : x : y; return ((h & 1) != 0 ? -u : u) + ((h & 2) != 0 ? -v :
         * v);
         */
        ...
        if (j == 1) {
            ...
            for (int i4 = 0; i4 < i; i4++) {
                ...
                for (int l4 = 0; l4 < k; l4++) {
                    ...
                    double d9 = lerp(
                        d17, 
                        func_4110_a(permutations[j1], d14, d19),
