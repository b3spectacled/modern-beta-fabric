...
import mod.bespectacled.modernbeta.api.world.gen.noise.VanillaNoiseProvider;
...
import mod.bespectacled.modernbeta.world.gen.sampler.DensitySampler;
import mod.bespectacled.modernbeta.world.gen.sampler.NoiseCaveSampler;
import mod.bespectacled.modernbeta.world.gen.sampler.NoodleCaveSampler;
import mod.bespectacled.modernbeta.world.gen.sampler.OreVeinSampler;
...
public abstract class NoiseChunkProvider extends ChunkProvider {
    ...
    public NoiseChunkProvider(OldChunkGenerator chunkGenerator) {
        ...
        this.oreVeinSampler = new OreVeinSampler(
            ...
            this.verticalNoiseResolution,
            this::sampleDeepslateState,
            Registries.ORE_VEIN_RULES.get(chunkGenerator.getChunkProviderType())
        );
     ...
     */
    private SimpleBlockSource createOreVeinProviders(ChunkPos chunkPos, Consumer<VanillaNoiseProvider> consumer) {
